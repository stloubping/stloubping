...
import { Activity, Facebook, Mail, Phone, MapPin } from 'lucide-react';
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 text-center md:text-left">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/administration/groupes-entrainement" className="text-sm text-clubDark-foreground/80 hover:text-clubPrimary transition-colors">Administrer les groupes</Link></li>
              <li className="pt-2">
                <a
                  href="/ping-tracker/"
                  ...
                  aria-label="Ouvrir Ping Tracker"
                >
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/equipe-1" className="text-sm text-clubDark-foreground/80 hover:text-clubPrimary transition-colors">Espace Équipe 1</Link></li>
              <li><Link to="/administration" className="text-sm text-clubDark-foreground/80 hover:text-clubPrimary transition-colors">Administration</Link></li>
            </ul>
          </div>
