        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 text-center md:text-left">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-clubDark-foreground/80">
              <li className="flex items-center justify-center md:justify-start"><MapPin size={16} className="mr-2 text-clubPrimary" /> 1 Rue du Stade, 33450 Saint-Loubès, France</li>
