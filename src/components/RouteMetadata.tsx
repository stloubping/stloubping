...
const metadataFor = (pathname: string): Metadata => {
  ...
  if (pathname === "/equipe-2") return { title: "Espace Équipe 2 — Saint-Loub'Ping", description: "Espace privé de gestion sportive de l’Équipe 2 de Saint-Loub'Ping.", noIndex: true };
