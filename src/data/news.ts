...
export const allNews: NewsItem[] = [
  {
    id: 1,
    title: "Le club de tennis de table loubésien a organisé sa compétition amicale annuelle dans la salle Jacques-Durieux, le 20 décembre",
    date: "2023-12-20",
  ...
  {
    id: 5,
    title: "Nouveaux équipements pour la saison 2024-2025",
    date: "2024-08-10",
    location: "Club House",
