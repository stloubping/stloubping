...
const jerseys = [
  {
    ...
    price: "35€",
    image: "https://via.placeholder.com/300x300/FF0000/FFFFFF?text=Maillot+Rouge",
  },
  {
    id: 2,
    ...
    price: "25€",
    image: "https://via.placeholder.com/300x300/000000/FFFFFF?text=Maillot+Noir",
  },
  {
    id: 3,
    ...
    price: "40€",
    image: "https://via.placeholder.com/300x300/FFFFFF/FF0000?text=Maillot+Rétro",
  },
];
...
const Boutique = () => {
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-4xl font-bold text-center mb-12 text-clubBlack">Boutique du Club</h1>

      <section className="mb-12 text-center">
        <Card className="bg-card shadow-lg p-8">
          <CardTitle className="text-2xl text-clubRed mb-4">Découvrez nos produits dérivés !</CardTitle>
          <CardContent>
            ...
            <Button asChild className="bg-clubRed hover:bg-clubRed/90 text-clubRed-foreground px-8 py-4 text-lg">
      ...
      <section>
        <h2 className="text-3xl font-bold text-center mb-8 text-clubBlack">Nos Maillots</h2>
          ...
          {jerseys.map((jersey) => (
            <Card key={jersey.id} className="bg-card shadow-md hover:shadow-lg transition-shadow duration-300 text-center">
              <CardContent className="p-6">
                ...
                <h3 className="text-xl font-semibold mb-2 text-clubBlack">{jersey.name}</h3>
                <p className="text-sm text-muted-foreground mb-4">{jersey.description}</p>
                <p className="text-2xl font-bold text-clubRed mb-4">{jersey.price}</p>
                <Button className="bg-clubBlack hover:bg-clubBlack/90 text-clubBlack-foreground">
                  Voir le produit
                </Button>
              </CardContent>
            </Card>
