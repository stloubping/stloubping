  ...
  return (
    <div className="bg-clubLight text-clubLight-foreground">
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        {/* Nouveau: Article Bonzai en dernière position */}
        <section className="mb-12">
          <h2 className="text-3xl font-bold text-center mb-8 text-clubDark">Actualités Bonzai.pro</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <BonzaiNewsCard />
          </div>
          <p className="mt-4 text-sm text-muted-foreground text-center">
            Note: Le titre, la description et l'image de l'article Bonzai sont actuellement des exemples statiques. Pour afficher le contenu dynamique, Bonzai.pro doit fournir un flux de données structuré (RSS ou API JSON).
          </p>
        </section>
