...
const LeClub = () => {
  return (
    <div className="container mx-auto px-4 py-8 bg-clubLight text-clubLight-foreground">
      <h1 className="text-4xl font-bold text-center mb-12 text-clubDark">Le Club</h1>
      ...
      <section className="mb-12">
        <Card className="bg-clubLight shadow-lg rounded-xl">
          ...
          <CardContent>
            <h3 className="text-xl font-semibold mb-2 text-clubDark">Horaires d'entraînement :</h3>
          ...
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              <div className="text-center">
                ...
                <h4 className="font-semibold text-clubDark">Jean Dupont</h4>
              ...
              <div className="text-center">
                ...
                <h4 className="font-semibold text-clubDark">Marie Curie</h4>
              ...
              <div className="text-center">
                ...
                <h4 className="font-semibold text-clubDark">Pierre Martin</h4>
