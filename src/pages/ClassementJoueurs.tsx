...
const ClassementJoueurs = () => {
  ...
  // Nouveau lien pour l'iframe, affichant les licenciés par classement officiel avec le thème 'deepGrey'
  const pingpocketClubRankingLink = "https://www.pingpocket.fr/app/fftt/clubs/10330022/licencies?SORT=OFFICIAL_RANK&themeId=deepGrey"; 
