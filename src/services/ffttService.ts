...
const CACHE_KEY = "stloub_club_players_v24";
...
export async function fetchClubPlayers(): Promise<Player[]> {
  ...
  // 2. Tente un appel Edge Function Supabase si déployé
  try {
  ...
  // 3. Tente l'accès direct Smartping avec proxy rapide
  ...
  // 4. Fallback instantané sur les 48 joueurs du club
